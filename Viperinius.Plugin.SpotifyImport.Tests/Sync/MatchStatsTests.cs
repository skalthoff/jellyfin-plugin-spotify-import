...
namespace Viperinius.Plugin.SpotifyImport.Tests.Sync
{
    public class MatchStatsTests
    {
        ...
        public void MatchedSumsFinderHitsOnly()
        {
            ...
            Assert.Equal(15, stats.Matched);
        }

        [Fact]
        public void AddAccumulatesEveryCounter()
        {
            var a = new MatchStats { TotalTracks = 1, CacheHits = 1, ManualMapHits = 2, IsrcReuseHits = 8, MusicBrainzHits = 3, StringMatchHits = 4, AlreadyInPlaylist = 5, NewlyAdded = 6, Missing = 7 };
            var b = new MatchStats { TotalTracks = 10, CacheHits = 10, ManualMapHits = 20, IsrcReuseHits = 80, MusicBrainzHits = 30, StringMatchHits = 40, AlreadyInPlaylist = 50, NewlyAdded = 60, Missing = 70 };
            ...
            Assert.Equal(88, a.IsrcReuseHits);

...
namespace Viperinius.Plugin.SpotifyImport.Tests.Sync
{
    ...
    public class ManualMapFinderTests
    {
        ...
        public async Task FindTrackOkById()
        {
            ...
            var entry2 = new ManualMapTrack();
            entry2.Jellyfin.Track = correctJfId.ToString();
            entry2.Provider.Id = correctProviderTrackInfo.Id;
            entry2.Provider.Name = "aod98wa";
            entry2.Provider.AlbumName = "nope";
            entry2.Provider.AlbumArtistNames.Add("498rga8sv");
            entry2.Provider.ArtistNames.Add("40APOd");
